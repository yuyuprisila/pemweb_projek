                ...
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="blog.php" class="dropdown-item active">Blog Kilasan</a>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="img/Menanam.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Berkebun itu Seru!</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                                <small class="mr-3"><i class="fa fa-folder text-primary"></i> Web Design</small>
                                <small class="mr-3"><i class="fa fa-comments text-primary"></i> 15</small>
                            </div>
                            <p>Mengajarkan tentang siklus hidup tumbuhan, memperkenalkan berbagai jenis sayuran dan buah-buahan, dan memberikan pengalaman belajar yang menyenangkan di luar ruangan</p>
                            <a href="single.php" class="btn btn-primary px-4 mx-auto my-2">Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="img/Menari.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Berbakat Menari</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                                <small class="mr-3"><i class="fa fa-folder text-primary"></i> Web Design</small>
                                <small class="mr-3"><i class="fa fa-comments text-primary"></i> 15</small>
                            </div>
                            <p>Anak-anak yang berminat menari diberikan kesempatan untuk tampil di acara sekolah dan kegiatan di luar sekolah seperti festival seni dan pentas seni.</p>
                            <a href="single.php" class="btn btn-primary px-4 mx-auto my-2">Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="img/Playing1.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Serunya Menjelajah</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Admin</small>
                                <small class="mr-3"><i class="fa fa-folder text-primary"></i> Web Design</small>
                                <small class="mr-3"><i class="fa fa-comments text-primary"></i> 15</small>
                            </div>
                            <p>Membentuk kelompok kecil dan mencari gambar-gambar tersembunyi di tempat-tempat yang berbeda. Anak-anak paling suka!</p>
                            <a href="single.php" class="btn btn-primary px-4 mx-auto my-2">Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
